"""
URL configuration for Sightings project.
...
schema_view = get_schema_view(
   openapi.Info(
      ...
      default_version='v1',
      description="A RESTFUL API that allows users to track and record wildlife sightings in a specific conservation area.",
